...
process.source = cms.Source("PoolSource",
       ...
       fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/PhaseIIMTDTDRAutumn18DR/TTbar_14TeV_TuneCP5_Pythia8/FEVT/PU200_103X_upgrade2023_realistic_v2-v1/80003/F3BC2890-9092-E44B-AF68-7ABD7EBE6D9C.root'),
...
chains.register_backend2("Histomaxth0shape0",
        lambda p,i : clustering3d.create_histoMax_variableDr(p,i,
    seed_threshold=0., shape_threshold=0.))
chains.register_backend2("Histomaxth20shape0",
        lambda p,i : clustering3d.create_histoMax_variableDr(p,i,
    seed_threshold=20., shape_threshold=0.))
...
chains.register_backend2("Histomaxdr50shape0",
        lambda p,i : clustering3d.create_histoMax_variableDr(p,i,
    distances=dr_layerbylayer_50, shape_threshold=0.))
chains.register_backend2("Histomaxdr200shape0",
        lambda p,i : clustering3d.create_histoMax_variableDr(p,i,
    distances=dr_layerbylayer_200, shape_threshold=0.))
# Register selector
...
backend_algos = ['Histomaxshape0', 'Histomaxth0shape0', 'Histomaxth20shape0', 'Histomaxdr50shape0', 'Histomaxdr200shape0']
